...
const textVariants = cva('w-fit', {
  variants: {
    variant: {
      ...
      title_2:
        'md:ui-text-[39px] msm:ui-text-[24px]  ui-font-semibold ui-text-brand-blackblue ',
      subtitle:
        'md:ui-text-[22px] msm:ui-text-[14px]  ui-font-regular ui-text-brand-lightblack',
      paragraph:
        'md:ui-text-[20px] ui-font-regular msm:ui-text-[14px]  ui-text-brand-lightblack  leading-loose',
      suptitle:
      ...
      heading4:
        'md:ui-text-[21px] ui-font-semibold msm:ui-text-[14px]  text-white',
      label:
